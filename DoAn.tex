\documentclass[a4paper,12pt,3p,twoside]{report}
\usepackage{times} % Chọn font Time New Romans - Load trước khi đổi size
...
% package content table - phải load trước caption để tránh xung đột
\usepackage{tocbasic}

\usepackage[font=small,labelfont=bf]{caption}
% Center captions globally for tables and figures
...
% Tránh kéo giãn khoảng trắng theo chiều dọc để lấp đầy trang
\raggedbottom
...
{\let\oldnumberline\numberline
\renewcommand{\numberline}[1]{Hình~\oldnumberline{#1}}
\listoffigures} 
...
{\let\oldnumberline\numberline
\renewcommand{\numberline}[1]{Bảng~\oldnumberline{#1}}
\listoftables}
...
\chapter{XÂY DỰNG KẾ HOẠCH KIỂM THỬ}
\label{chapter:Related_works}
\subfile{Chuong/2_Phuong_phap}
...
% \subfile{Chuong/3_Thu_thap_thong_tin}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{KIỂM THỬ HỆ THỐNG}
\label{chapter:Experiment}
\subfile{Chuong/4_Quy_trinh_kiem_thu}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{CÁC ĐÓNG GÓP NỔI BẬT}
\label{chapter:SolutionAndContribution}
\subfile{Chuong/5_Dong_gop_noi_bat}
\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter*{KẾT LUẬN}
...
%\mainmatter
\titleformat{\chapter}[hang]{\centering\bfseries}{}{0pt}{}[]
\titlespacing*{\chapter}{0pt}{-20pt}{20pt}

\titlecontents{chapter}
    [0.0cm]             % left margin
    {\bfseries\vspace{0.3cm}}                  % above code
    {{\bfseries{\scshape} }} % numbered format (ẩn nhãn A. vì chỉ có một phụ lục)
    {}         % unnumbered format
    {\titlerule*[0.3pc]{.}\contentspage}         % filler-page-format, e.g dots
\chapter*{PHỤ LỤC: MỤC ĐÍCH CỦA CÁC NỘI DUNG KIỂM THỬ THEO TỪNG DANH MỤC}
\addcontentsline{toc}{chapter}{MỤC ĐÍCH CỦA CÁC NỘI DUNG KIỂM THỬ THEO TỪNG DANH MỤC}
