...
Việc không triển khai cơ chế bảo vệ chống tấn công brute force làm suy giảm đáng kể mức độ an 
toàn của chức năng xác thực. Lỗ hổng này cho phép kẻ tấn công thực hiện số lượng lớn các lần thử 
đăng nhập nhằm đoán mật khẩu, từ đó làm gia tăng nguy cơ chiếm quyền truy cập tài khoản người dùng. 
Đặc biệt, đối với các tài khoản sử dụng mật khẩu yếu hoặc bị lộ thông tin xác thực từ các nguồn khác, 
khả năng bị khai thác là rất cao. Ngoài ra, việc cho phép thực hiện số lượng lớn các yêu cầu 
đăng nhập liên tiếp còn có thể bị lợi dụng để làm cạn kiệt tài nguyên hệ thống, dẫn đến suy giảm 
tính sẵn sàng của dịch vụ và gây gián đoạn quá trình truy cập của người dùng hợp lệ.
...
Để giảm thiểu nguy cơ tấn công brute force, hệ thống cần triển khai một hoặc 
kết hợp nhiều biện pháp bảo vệ phù hợp. Cụ thể, cần áp dụng cơ chế khóa tài 
khoản sau một số lần đăng nhập không thành công liên tiếp (thông thường từ 
5 đến 10 lần) nhằm hạn chế số lượng thử đoán mật khẩu. Bên cạnh đó, hệ thống 
nên triển khai cơ chế giới hạn tần suất đăng nhập dựa trên tài 
khoản, địa chỉ IP hoặc thiết bị truy cập. Việc sử dụng CAPTCHA khi phát hiện 
nhiều lần đăng nhập thất bại liên tiếp cũng góp phần ngăn chặn các công cụ tự động. Ngoài ra, có thể áp dụng cơ chế trì hoãn tăng dần giữa các lần thử đăng nhập để làm giảm hiệu quả của các cuộc tấn công brute force. Cuối cùng, hệ thống cần tăng cường giám sát và ghi log các hành vi đăng nhập bất thường nhằm phục vụ công tác phát hiện sớm và xử lý sự cố bảo mật.
...
:ỗ hổng SQL Injection cho phép kẻ tấn công xác định và liệt kê tên các bảng trong cơ sở 
