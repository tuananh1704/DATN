...
Mô hình kiểm thử của quy trình kiểm thử bảo mật ứng dụng web OWASP là một hệ thống hóa gồm các kỹ thuật kiểm 
thử bảo mật có thể áp dụng, cung cấp giải thích chi tiết cho từng kỹ thuật và duy trì việc cập nhật liên tục 
tài liệu hướng dẫn. Mô hình kiểm thử này gồm các thành phần sau: người kiểm thử, công cụ và phương pháp, ứng 
dụng cần kiểm thử \cite{owasp_model}. 
...
Trong quá trình kiêm thử, giai đoạn 10: Kiểm thử logic nghiệp vụ không được đưa vào phạm vi thực hiện do 
...
SQLmap là một công cụ kiểm thử xâm nhập mã nguồn mở, được thiết kế 
nhằm tự động hóa quá trình phát hiện và khai thác các lỗ hổng SQL 
Injection trên ứng dụng web. Công cụ này cho phép người kiểm thử 
đánh giá khả năng chiếm quyền kiểm soát máy chủ cơ sở dữ liệu thông 
qua các điểm đầu vào không an toàn. SQLmap được trang bị cơ chế phát 
hiện mạnh mẽ cùng nhiều tính năng chuyên sâu, bao gồm nhận dạng loại 
và phiên bản cơ sở dữ liệu, trích xuất dữ liệu, truy cập hệ thống 
tệp phía máy chủ và thực thi lệnh trên hệ điều hành thông qua các 
kênh kết nối ngoài băng (out-of-band). Nhờ đó, SQLmap hỗ trợ hiệu 
quả quá trình đánh giá mức độ ảnh hưởng và phạm vi khai thác của 
