...
\subsection*{a) Thu thập thông tin}
...
\subsection*{b) Kiểm thử cấu hình và quản lý triển khai}
\begin{longtable}{|>{\centering\arraybackslash}p{1.3cm}|p{4.5cm}|p{7.7cm}|}
...
\subsection*{c) Kiểm thử quản lý định danh}
\begin{longtable}{|>{\centering\arraybackslash}p{1.3cm}|p{4.5cm}|p{7.7cm}|}
...
\subsection*{d) Kiểm thử xác thực}
\begin{longtable}{|>{\centering\arraybackslash}p{1.3cm}|p{4.5cm}|p{7.7cm}|}
...
\subsection*{e) Kiểm thử phân quyền}
\begin{longtable}{|>{\centering\arraybackslash}p{1.3cm}|p{4.5cm}|p{7.7cm}|}
...
\subsection*{f) Kiểm thử quản lý phiên làm việc}
\begin{longtable}{|>{\centering\arraybackslash}p{1.3cm}|p{4.5cm}|p{7.7cm}|}
...
\subsection*{g) Kiểm thử xác thực dữ liệu đầu vào}
\begin{longtable}{|>{\centering\arraybackslash}p{1.3cm}|p{4.5cm}|p{7.7cm}|}
...
\subsection*{h) Kiểm thử xử lý lỗi}
\begin{longtable}{|>{\centering\arraybackslash}p{1.3cm}|p{4.5cm}|p{7.7cm}|}
...
\subsection*{i) Kiểm thử mật mã yếu}
\begin{longtable}{|>{\centering\arraybackslash}p{1.3cm}|p{4.5cm}|p{7.7cm}|}
...
\subsection*{j) Kiểm thử phía máy khách}
\begin{longtable}{|>{\centering\arraybackslash}p{1.3cm}|p{4.5cm}|p{7.7cm}|}
...
\subsection*{k) Kiểm thử API}
\begin{longtable}{|>{\centering\arraybackslash}p{1.3cm}|p{4.5cm}|p{7.7cm}|}

\caption{Mục đích của nội dung kiểm thử API}\\
\hline
\textbf{Mã} & \textbf{Nội dung kiểm thử} & \textbf{Mục tiêu} \\
\hline
\endfirsthead
...
Xác định toàn bộ các API endpoint được backend hỗ trợ, bao gồm cả các endpoint đã được tài liệu hóa và chưa được tài liệu hóa. Đồng thời xác định tất cả các tham số của từng endpoint mà backend xử lý và khám phá các dữ liệu liên quan đến API được nhúng trong HTML hoặc mã JavaScript gửi tới phía client.
\\ \hline

WSTG-APIT-02 &
Kiểm thử kiểm soát truy cập theo đối tượng trong API &
Đánh giá việc API có thực thi đầy đủ cơ chế phân quyền ở mức đối tượng hay không, nhằm đảm bảo rằng người dùng chỉ có thể truy cập và thao tác trên các đối tượng mà họ được phép tương tác.
\\ \hline

WSTG-APIT-99 &
Kiểm thử GraphQL &
Đánh giá việc triển khai GraphQL có được cấu hình an toàn và sẵn sàng cho môi trường sản xuất hay không, đồng thời xác thực tất cả các trường dữ liệu đầu vào trước các hình thức tấn công phổ biến và đảm bảo các cơ chế kiểm soát truy cập được áp dụng đầy đủ.
\\ \hline
